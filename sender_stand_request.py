...
def get_docs():
    ...
    return requests.get(configuration.URL_SERVICE + configuration.DOC_PATH, verify=False)
...
def get_users_table():
    return requests.get(configuration.URL_SERVICE + configuration.USERS_TABLE_PATH, verify=False)
